...
function varargout = numerical_methods(varargin)
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @numerical_methods_OpeningFcn, ...
                   'gui_OutputFcn',  @numerical_methods_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before numerical_methods is made visible.
function numerical_methods_OpeningFcn(hObject, eventdata, handles, varargin)
%
...
function varargout = numerical_methods_OutputFcn(hObject, eventdata, handles) 
